...
def populate_course_instructor_relationships():
    ...
    course_python.instructors.add(instructor_joy)
...
def populate_course_enrollment_relationships():
    ...
    mary_python = Enrollment.objects.create(learner=learner_mary, course=course_python, date_enrolled=date(2023, 6, 18), mode='audit')
    mary_python.save()
